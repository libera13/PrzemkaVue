  ...
  <section class="content_wrap">
    ...
    <ul class="box">
      ...
      <li>
        <div class="circle">
          <div class="front">
            <div class="title color-1-font">samogasnąca</div>
            <div class="price color-1-font">
              <!--              <span class="end"></span>-->
            </div>
            <div class="description">
              w razie pożaru zwęgla się, co zapobiega rozprzestrzenianiu się
              ognia (klasa B2)
            </div>
          </div>
          <!-- end div .front -->
      ...
      <li>
        <div class="circle">
          <div class="front">
            <div class="title color-2-font">ekologiczna</div>
            <div class="price color-2-font">
              <!--              <span class="currency">$</span>-->
              <!--              <span class="total">15</span>-->
              <!--              <span class="end">99</span>-->
            </div>
            <div class="description">
              nie wydziela żadnych substancji przez cały okres użytkowania
            </div>
          </div>
          <!-- end div .front -->
      ...
      <li>
        <div class="circle">
          <div class="front">
            <div class="title color-4-font">efektywna</div>
            <div class="price color-4-font">
              <!--              <span class="currency">$</span>-->
              <!--              <span class="total">39</span>-->
              <!--              <span class="end">99</span>-->
            </div>
            <div class="description">
              najlepsze parametry izolacyjne ze wszystkich dostępnych materiałów
            </div>
          </div>
          <!-- end div .front -->
          <div class="back color-4-bg info">
            ...
            <div class="description">
              <ul>
                <li>
                  najlepsze parametry izolacyjne ze wszystkich dostępnych
                  materiałów
                </li>
              </ul>
            </div>
